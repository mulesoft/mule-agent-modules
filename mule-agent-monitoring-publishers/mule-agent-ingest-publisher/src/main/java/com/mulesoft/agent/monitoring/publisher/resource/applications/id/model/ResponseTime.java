...
public class ResponseTime {
     ...
     * @param time
     */
    public ResponseTime(Date time, Double min, Double max, Double sum, Double avg, Double count) {
        this.time = time;
        this.min = min;
        this.max = max;
        this.sum = sum;
    ...
    public ResponseTime withTime(Date time) {
        this.time = time;
        return this;
    }
    ...
    public ResponseTime withMin(Double min) {
        this.min = min;
        return this;
    }
    ...
    public ResponseTime withMax(Double max) {
        this.max = max;
        return this;
    }
    ...
    public ResponseTime withSum(Double sum) {
        this.sum = sum;
        return this;
    }
    ...
    public ResponseTime withAvg(Double avg) {
        this.avg = avg;
        return this;
    }
    ...
    public ResponseTime withCount(Double count) {
        this.count = count;
        return this;
    }
    ...
    public ResponseTime withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
