...
public class GarbageCollectionTimeMetricFactoryTest
{
    ...
    public void supportsTheCorrectJMXBeans()
    {
        ...
        Assert.assertEquals(7, supportedMetrics.size());
        Assert.assertTrue("Supported metrics didn't contain GC_COPY_TIME", supportedMetrics.contains(SupportedJMXBean.GC_COPY_TIME));
        ...
        Assert.assertTrue("Supported metrics didn't contain GC_PS_SCAVENGE_TIME", supportedMetrics.contains(SupportedJMXBean.GC_PS_SCAVENGE_TIME));
        Assert.assertTrue("Supported metrics didn't contain GC_G1_YOUNG_GENERATION_TIME", supportedMetrics.contains(SupportedJMXBean.GC_G1_YOUNG_GENERATION_TIME));
        ...
        Assert.assertTrue("Supported metrics didn't contain GC_PS_MARK_SWEEP_TIME", supportedMetrics.contains(SupportedJMXBean.GC_PS_MARK_SWEEP_TIME));
        Assert.assertTrue("Supported metrics didn't contain GC_G1_OLD_GENERATION_TIME", supportedMetrics.contains(SupportedJMXBean.GC_G1_OLD_GENERATION_TIME));
    }
