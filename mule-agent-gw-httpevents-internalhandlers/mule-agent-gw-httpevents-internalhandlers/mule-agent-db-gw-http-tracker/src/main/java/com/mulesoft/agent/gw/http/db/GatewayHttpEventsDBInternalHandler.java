...
@Singleton
public class GatewayHttpEventsDBInternalHandler extends AbstractDBInternalHandler<AnalyticsHttpEvent>
{
    ...
    private UUID insertEvent(PreparedStatement statement, AnalyticsHttpEvent event)
            throws SQLException
    {
